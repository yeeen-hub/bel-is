<template>
  <LandingLayout>
    <div class="container mx-auto px-6" id="home">

      <!-- ── Hero ─────────────────────────────────────────────────────────── -->
      <div class="relative h-[550px]">
        <div class="absolute inset-0 flex items-center justify-between px-16">
          <div>
            <h2 class="text-6xl text-white mb-4 font-heading leading-normal">
              Discover the beauty of
              <span class="text-white-800 text-9xl font-bold">BEL-IS</span>
            </h2>
            <p class="border-2 border-white text-white p-2 text-xl rounded-lg inline-flex">
          ...
          <img
            ...
            alt="Virtual Map"
            class="w-1/8 max-w-[550px] animate-float"
          />
        </div>
      </div>

      <!-- ── Attractions ────────────────────────────────────────────────────── -->
      <div class="mt-16" id="attractions">
        ...
        <div class="flex justify-center mt-6">
          <div class="inline-flex gap-4 p-2 rounded-lg bg-white">
            <a class="px-3 py-1 border border-gray-300 rounded-md text-gray-600 hover:bg-blue-600 hover:text-white cursor-pointer">All</a>
            <a class="px-3 py-1 border border-gray-300 rounded-md text-gray-600 hover:bg-blue-600 hover:text-white cursor-pointer">Recommended</a>
            <a class="px-3 py-1 border border-gray-300 rounded-md text-gray-600 hover:bg-blue-600 hover:text-white cursor-pointer">Popular</a>
          </div>
        </div>

        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          <div v-for="n in 6" :key="n" class="bg-white rounded-lg shadow-md overflow-hidden">
            <img src="/images/h-resort.jpg" class="w-full h-48 object-cover" alt="Bel-is Resort">
            <div class="p-3">
              <div class="flex justify-between">
                <h3 class="font-semibold">Bel-is Resort</h3>
                <span class="text-sm text-gray-600">⭐ 4.3</span>
              </div>
              <hr class="border-1 border-gray mt-2">
        ...
        <!-- Pagination -->
        <div class="max-w-6xl mx-auto flex items-center justify-between mt-6">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2">
          ...
          <div class="p-6 overflow-y-auto">
            ...
            <div class="flex items-center bg-gray-100 rounded-lg px-3 py-2 mb-4">
              <svg version="1.0" class="mr-2" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 64 64" fill="#000000">
              ...
              <input type="text" placeholder="Pick a location to explore..."
                class="flex-1 outline-none border-none focus:ring-0 focus:outline-none bg-gray-100" />
              <div class="p-2 bg-blue-700 rounded-full inline-flex">
            ...
            <div class="grid grid-cols-1 gap-4">
              <div v-for="n in 2" :key="n" class="flex gap-4 border rounded-lg p-3">
                <img src="/images/h-resort.jpg" class="w-58 h-36 object-cover rounded-md" alt="Resort">
                <div class="flex-1 mt-3">
                  <h3 class="font-semibold text-lg">Bel-is Resort</h3>
                  <div class="flex items-center gap-1 mt-2">
                    <svg fill="#0036d6" width="14px" height="14px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="text-sm text-gray-500">Kalibo, Aklan</p>
                  </div>
                  <div class="flex items-center gap-1 text-sm mt-1">
                    <p class="font-medium">4.3</p>
                    <svg fill="#ffd500" width="14px" height="14px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke="#ffd500">
                    ...
                    <span>(59)</span>
                    <span class="w-1.5 h-1.5 bg-gray-500 rounded-full inline-block mx-1"></span>
                    <span class="text-gray-500">2 min</span>
                  </div>
      ...
      <!-- ── About ─────────────────────────────────────────────────────────── -->
      <div id="about" class="mt-16 w-full relative bg-cover bg-center bg-no-repeat"
        style="background-image: url('/images/abstractbg.jpg')">
        <div class="absolute inset-0 bg-black/10 backdrop-blur-sm"></div>
        <div class="relative z-10 flex flex-col items-center justify-center px-4 text-center py-16">

          <p class="text-sm sm:text-base md:text-lg mb-2 uppercase tracking-wider">About Us</p>
          <h2 class="font-bold text-2xl sm:text-3xl md:text-5xl leading-snug md:leading-tight">
            What is Bel-is?
          </h2>

          <div class="mt-8 w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            <div class="w-full h-full">
              <img src="/images/h-resort.jpg" alt="Bel-is Resort"
                class="w-full h-full object-cover rounded-lg shadow-lg">
            </div>
            <div class="flex flex-col justify-center text-left px-2 space-y-6">
              <div class="flex gap-4 items-start">
                <p class="text-lg font-bold text-gray-500 flex-shrink-0">01</p>
                <div>
                  <p class="font-semibold text-2xl">Our History</p>
              ...
              <div class="flex gap-4 items-start">
                ...
                <div>
                  <p class="font-semibold text-2xl">Culture &amp; Traditions</p>
                  <p class="text-md mt-3 text-gray-800">
              ...
              <div class="flex gap-4 items-start">
                ...
                <div>
                  <p class="font-semibold text-2xl">Nature &amp; Environment</p>
                  <p class="text-md mt-3 text-gray-800">
      ...
      <!-- ── Contact ────────────────────────────────────────────────────────── -->
      <div id="contact" class="mt-16 max-w-6xl mx-auto">
        <p class="text-sm">Get Started</p>
        <div class="grid grid-cols-2 items-start">
          ...
          <div class="flex flex-col items-end gap-6 pt-2">
      ...
      <!-- Placed just before the footer for a final conversion push          -->
      <div class="mt-16 max-w-6xl mx-auto" id="pre-register">
        <div class="bg-gray-900 rounded-2xl overflow-hidden">
          <div class="grid grid-cols-1 md:grid-cols-2 items-center">
            ...
            <!-- Right: Reference code card mockup -->
      ...
      <div class="mt-16 w-full relative bg-cover bg-center bg-no-repeat"
        style="background-image: url('/images/abstractbg.jpg')">
        <div class="absolute inset-0 bg-black/10 backdrop-blur-sm"></div>
