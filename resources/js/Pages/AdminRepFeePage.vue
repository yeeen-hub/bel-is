<template>
    <SidebarLayout>
        ...
        <h1 class="font-heading text-gray-800 font-semibold text-2xl">Fee Revenue</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-4 gap-4 mt-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-800">₱{{ avgDaily }}</p>
            </div>
        </div>
        ...
        <div class="mt-5">
            ...
            <div v-if="showFilter" ref="filterRef"
                ...
                <!-- Visit Category — from DB fee_categories -->
                <div>
                    ...
                    <select v-model="category"
                        ...
                        <option v-for="cat in feeCategories" :key="cat.id" :value="cat.category">
                            {{ cat.category }}
                            <template v-if="cat.age_range"> ({{ cat.age_range }})</template>
                        </option>
                    </select>
                </div>
...
const props = defineProps({
    ...
    // ← from DB fee_categories — no more hardcoded options
