            ...
            <div class="bg-gray-100 p-4 rounded-lg flex items-center gap-4">
                ...
                <div class="relative" ref="bellRef">
                    <button @click="toggleNotifications" class="relative focus:outline-none">
                        ...
                        <!-- ✅ Red badge only for pending_fees — pre-reg is not urgent -->
                        <span v-if="stats.pending_fees > 0"
                            ...
                            {{ stats.pending_fees > 9 ? '9+' : stats.pending_fees }}
                        </span>
                    </button>
                    ...
                    <div v-if="showNotifications"
                        ...
                        <div class="max-h-72 overflow-y-auto">
                            ...
                            <!-- ✅ Pre-reg — informational only, no action link -->
                            <div v-if="stats.pending_pre_reg > 0"
                                class="flex items-start gap-3 px-4 py-3 bg-blue-50 border-b border-blue-100">
                                <div class="mt-0.5 flex-shrink-0">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm font-semibold text-blue-800">
                                        {{ stats.pending_pre_reg }} potential visitor(s) incoming
                                    </p>
                                    <p class="text-xs text-blue-600 mt-0.5">
                                        These visitors pre-registered online and may be on their way.
                                        Wait for them to present their reference code at the checkpoint.
                                    </p>
                                </div>
                            </div>

                            <!-- ✅ Empty state only checks pending_fees -->
                            <div v-if="stats.pending_fees === 0"
            ...
            <div v-if="stats.pending_pre_reg > 0" class="px-4 pb-2">
                <div class="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600 mt-0.5">
                            They may be on their way. Process them only when they arrive and present their reference code at the checkpoint.
                        </p>
                    </div>
                </div>
            </div>
